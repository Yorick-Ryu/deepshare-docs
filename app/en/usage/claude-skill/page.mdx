export const metadata = {
  title: "Export Word in Claude Code with the md2docx Skill",
  description: "In Claude Code, you can use the md2docx Skill to directly convert Markdown content to professionally formatted Word documents. This Skill lets Claude autom...",
  alternates: {
    canonical: "/en/usage/claude-skill/",
  },
  openGraph: {
    title: "Export Word in Claude Code with the md2docx Skill",
    description: "In Claude Code, you can use the md2docx Skill to directly convert Markdown content to professionally formatted Word documents. This Skill lets Claude autom...",
    url: "/en/usage/claude-skill/",
    siteName: "DeepShare",
...
- **Purchase/Query**: [https://ds.rick216.cn/en/price.html](https://ds.rick216.cn/en/price.html)
